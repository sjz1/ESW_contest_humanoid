...
def letterdetect(cap):
    ...
    for i in range(10):
        ret, src = cap.read()
        imgchar=pytesseract.image_to_string(src)
...
# def Black_detect(ser, cap):


#-----------------------------------------------
############## 초록색 인식(제어보드로부터 Green_detect 수신) ##############
# def Green_detect(ser, cap):
        ...
        while ser.inWaiting() > 0:
            ...
            if RX == 16:
                ...
                # : 0개일 때 -> 들려야하는 미션방이 0개 남은 상태
                    ...
                    # 미션 수행해야하는 방이 1개 이하 남았을 때
                    if Letter_cnt < 2:
                        TX_data(ser, flag)
  
                        # 미션 수행해야하는 방이 없을 때 -> 앵글 조절 후, ㅏ/ㅓ 구분
                        if Letter_cnt == 0:
                ...
                # ----- 시민 인식 신호 ------
                    ...
                    # 시민 그랩 여부
                    flag = grap(cap,grap_blue_color1,grap_blue_color2,is_near,grap_sensitive)
...
if __name__ == '__main__':
    ...
    serial_c.daemon = True # 수신을 하는 스레드는 데몬 스레드
    serial_c.start()
    time.sleep(1)
